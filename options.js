...
function imagezoom_saveOptions() {
    ...
    nsIPrefBranchObj.setBoolPref("togglefitmax", document.getElementById("imagezoomtogglefitmax").checked);
...
function imagezoom_initializeOptions() {
    ...
    document.getElementById("imagezoomtogglefitmax").checked = nsIPrefBranchObj.getBoolPref("togglefitmax");
